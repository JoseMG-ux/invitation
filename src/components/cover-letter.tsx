        ...
        <div className="grid grid-cols-6 md:grid-cols-12 gap-6 md:gap-4 items-center justify-center">
          ...
          <div className="flex flex-col col-span-8 border-3 border-solid border-red-400 w-[100%] justify-center items-center">
            <div className="flex justify-center items-center text-center border-1 border-solid border-black w-[50%]">
              <h2 className="text-balance text-5xl font-semibold tracking-tight text-gray-900">
                XV de Nombre apellido1 apellido2
              </h2>
            </div>
            <Divider className="mt-5 w-5/6" />
            <Divider className="mt-5 w-5/6" />
            <div className="flex flex-col gap-4 my-8 justify-center items-center text-center text-large text-default-400 ">
              <p>
                Hoy atesoro con añoranza los recuerdos de mi niñez, como una
                adolescente que se convertirá en mujer. En este momento tan
                único, nada me haría más feliz que tu compañía.
              </p>
              <p className="italic text-blue-900">
                Todo lo puedo en cristo que me fortalece.
              </p>
              <p className="italic text-blue-900">Fil 4:13</p>
